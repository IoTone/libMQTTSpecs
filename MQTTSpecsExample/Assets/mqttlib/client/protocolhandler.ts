...
// PORTING: no global WebSocket module and no window
...
import { MQTTObjectController } from '../../ExampleAssets/MQTTObjectController';
...
class Pinger {
    ...
    private timeout?: Interval;
    private pingerCb: PingerCallback;
    constructor(keepAliveInterval: number, pingerCb: PingerCallback, sceneObj: BaseScriptComponent) {
        this.scriptComp = sceneObj;

        this.keepAliveInterval = keepAliveInterval * 1000;
        this.isReset = false;
        this.timeout = new Interval(this.scriptComp);
        ...
        */
        this.timeout.setTimeoutInSec(this.doTimeout, this.keepAliveInterval);
        this.timeout.resetInterval();
...
export class ProtocolHandler implements PingerCallback {
    ...
    constructor(uri: string, options: Options, emitter: TypedEventEmitter<MessageEvents>, sceneObj: BaseScriptComponent) {
        this.scriptComp = sceneObj;
        ...
        this.pinger = new Pinger(0, this, this.scriptComp);
        ...
        return new Promise((resolve, reject) => {
            ...
            */
            ...
            this.webSocket.onclose = (event) => {
                let e: Error;
                // WS api doesn't seem to match what is here: https://developers.snap.com/lens-studio/api/lens-scripting/classes/Built-In.WebSocketCloseEvent.html
                /*
                if (event.code === 1000) {
